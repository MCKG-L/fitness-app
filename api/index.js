...
// /**
//    * 调用 flash (pose_estimation) 接口
//    * @param {string} exercise 运动类型 (例如: 'curl', 'pushup')
//    * @param {object} data  请求数据, 包含 image 字段 (Base64 编码的图像)
//    * @returns {Promise}
//    */
// export const  callPoseEstimationApi =  (exercise, data) => {
//     return http.request({
//       url: `/pose_estimation/${exercise}`,
//       method: 'POST',
//       data: data,
