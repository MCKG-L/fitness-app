...
<mescroll-uni @init="mescrollInit" :up="upOption" :down="downOption" @down="downCallback" @up="upCallback">
	<view class="content">
		<view class="container" :style='{"minHeight":"100vh","width":"100%","padding":"0","position":"relative","background":"#F4F8FB","height":"auto"}'>
				...
				<view class="detail-list-item" :style='{"padding":"0 30rpx","margin":"0 0 24rpx 0","borderColor":"#ccc","borderWidth":"0","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"width":"auto","padding":"0 20rpx 0 0","lineHeight":"80rpx","fontSize":"28rpx","color":"#333"}'>节数：</view>
					<view  class="text" :style='{"padding":"0px","margin":"0px","lineHeight":"80rpx","fontSize":"28rpx","color":"rgb(0, 0, 0)"}'>{{detail.jieshu}}</view>
				</view>
				<view class="detail-list-item" :style='{"padding":"0 30rpx","margin":"0 0 24rpx 0","borderColor":"#ccc","borderWidth":"0","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"width":"auto","padding":"0 20rpx 0 0","lineHeight":"80rpx","fontSize":"28rpx","color":"#333"}'>应付金额：</view>
					<view  class="text" :style='{"padding":"0px","margin":"0px","lineHeight":"80rpx","fontSize":"28rpx","color":"rgb(0, 0, 0)"}'>{{detail.yingfujine}}</view>
				</view>
				<view class="detail-list-item" :style='{"padding":"0 30rpx","margin":"0 0 24rpx 0","borderColor":"#ccc","borderWidth":"0","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
				...
				<view class="bottom-content bg-white tabbar border shop" :style='{"width":"100%","padding":"10rpx 24rpx","flexWrap":"wrap","background":"#f4f8fb","display":"flex","height":"auto"}'>
					...
					<button :style='{"border":"0","padding":"0 20rpx","margin":"10rpx","color":"rgb(255, 255, 255)","borderRadius":"8rpx","background":"#87e4ec","width":"auto","fontSize":"28rpx","height":"80rpx","order":"1"}' @tap="onPayTap" v-if="userid&&isAuth('kechengdingdan','支付') && detail.ispay!='已支付'"  class="cu-btn bg-brown round shadow-blur">支付</button>
					<button :style='{"border":"0","padding":"0 20rpx","margin":"10rpx","color":"rgb(255, 255, 255)","borderRadius":"8rpx","background":"#87e4ec","width":"auto","fontSize":"28rpx","height":"80rpx","order":"1"}' @tap="onPayTap" v-if="!userid&&isAuthFront('kechengdingdan','支付') && detail.ispay!='已支付'"  class="cu-btn bg-brown round shadow-blur">支付</button>
					<button :style='{"border":"0","padding":"0 20rpx","margin":"10rpx","color":"rgb(255, 255, 255)","borderRadius":"8rpx","background":"#87e4ec","width":"auto","fontSize":"28rpx","height":"80rpx","order":"1"}' v-if="!isAuth('kechengdingdan','支付') && detail.ispay!='已支付'" class="cu-btn bg-brown round shadow-blur">未支付</button>
					<button :style='{"border":"0","padding":"0 20rpx","margin":"10rpx","color":"rgb(255, 255, 255)","borderRadius":"8rpx","background":"#87e4ec","width":"auto","fontSize":"28rpx","height":"80rpx","order":"1"}' v-if="detail.ispay=='已支付'"  class="cu-btn bg-brown round shadow-blur">已支付</button>
	...
	export default {
		...
		async onShow(options) {
            ...
            if(crossCleanType) {
                ...
                res = await this.$api.info('kechengdingdan', this.id);
		...
		methods: {
			...
			onPayTap(){
				...
				uni.setStorageSync('paytable','kechengdingdan');
			...
			async onAcrossTap(tableName,crossOptAudit,crossOptPay,statusColumnName,tips,statusColumnValue,type=1){
				...
				uni.setStorageSync('crossTable','kechengdingdan');
			...
			async init(type=1){
				...
				let res = await this.$api.info('kechengdingdan', this.id);
				this.detail = res.data;
				...
				if(type==2){
					...
					await this.$api.update('kechengdingdan',this.detail)
				}
			},
