	...
	<view class="content">
		<view :style='{"width":"100%","padding":"24rpx 24rpx 0px","background":"#F4F8FB","height":"100vh"}'>
			<view v-if="user&&user.id" :style='{"padding":"24rpx","margin":"0 0 20rpx 0","borderRadius":"20rpx","background":"#fff","display":"flex","width":"100%","position":"relative","height":"280rpx"}' @tap="onPageTap('../user-info/user-info')" class="header" v-bind:class="{'status':isH5Plus}">
				<view :style='{"width":"100%","flexWrap":"wrap","display":"flex","height":"100%"}' v-if="tableName=='jiaolian'" class="userinfo">
					<image :style='{"width":"88rpx","padding":"0","margin":"0 20rpx 0 0","borderRadius":"100%","height":"88rpx"}' :src="user.zhaopian?baseUrl+user.zhaopian:'/static/gen/upload.png'"></image>
					<view :style='{"flex":"1","flexDirection":"column","justifyContent":"center","display":"flex"}' class="info">
						<view :style='{"width":"100%","lineHeight":"36rpx","fontSize":"24rpx","color":"#000000"}'>{{user.jiaoliangonghao}}<text v-if="user.vip&& user.vip=='是'">(VIP)</text></view>
					</view>
					
					<view :style='{"width":"100%","margin":"16rpx 0","flexWrap":"wrap","justifyContent":"space-around","display":"flex"}' class="info">
					</view>
				</view>
				<view :style='{"width":"100%","flexWrap":"wrap","display":"flex","height":"100%"}' v-if="tableName=='huiyuan'" class="userinfo">
					...
					<view :style='{"width":"100%","margin":"16rpx 0","flexWrap":"wrap","justifyContent":"space-around","display":"flex"}' class="info">
						<view :style='{"color":"#0060C8","lineHeight":"36rpx","fontSize":"24rpx"}'>手机：{{user.shoujihaoma}}</view>
					</view>
				</view>
			...
			<view :style='{"width":"100%","height":"auto"}' class="list">
				...
				<view :style='{"width":"100%","overflow":"hidden","borderRadius":"20rpx","background":"#fff","height":"auto"}'>
					...
					<view :style='{"width":"100%","padding":"0 24rpx","flexWrap":"wrap","display":"flex","height":"auto"}'>
						...
						<view @tap="onPageTap('../chat/chat')" :style='{"borderColor":"#ccc","alignItems":"center","borderWidth":"0","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class="li" hover-class="hover">
							<view :style='{"color":"#000000","lineHeight":"1","fontSize":"40rpx"}' class="cuIcon-service"></view>
							<view class="text" :style='{"width":"100%","padding":"0 20rpx","lineHeight":"88rpx","fontSize":"28rpx","color":"#000000","flex":"1"}'>在线咨询</view>
							<view :style='{"width":"28rpx","lineHeight":"28rpx","fontSize":"28rpx","color":"#999"}' class="icon iconfont icon-jinru"></view>
						</view>
						...
						<view @tap="onPageTap('../messages/list')" :style='{"borderColor":"#ccc","alignItems":"center","borderWidth":"0","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class="li" hover-class="hover">
							<view :style='{"color":"#000000","lineHeight":"1","fontSize":"40rpx"}' class="cuIcon-message"></view>
							<view class="text" :style='{"width":"100%","padding":"0 20rpx","lineHeight":"88rpx","fontSize":"28rpx","color":"#000000","flex":"1"}'>留言板</view>
							<view :style='{"width":"28rpx","lineHeight":"28rpx","fontSize":"28rpx","color":"#999"}' class="icon iconfont icon-jinru"></view>
						</view>
			...
			<!-- 推荐 -->
			<view class="recommend" :style='{"padding":"0 0 140rpx","margin":"20rpx 0 0","overflow":"hidden","borderRadius":"20rpx","background":"#fff","width":"100%","height":"auto"}' v-if="recommendList.length">
				<view :style='{"width":"100%","padding":"0 24rpx","lineHeight":"80rpx","fontSize":"32rpx","color":"#0060C8","fontWeight":"700"}'>为你推荐</view>
				<view :style='{"padding":"0 20rpx 20rpx","flexWrap":"wrap","background":"#fff","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
					<view v-for="(item,index) in recommendList" :key="index" :style='{"width":"48%","boxShadow":"0 2rpx 4rpx rgba(0,0,0,.3)","margin":"20rpx 0 0 0","borderRadius":"20rpx","background":"#fff","height":"auto"}' @click="recommendDetail(item.id)">
						<image :style='{"width":"100%","objectFit":"cover","borderRadius":"20rpx","display":"block","height":"200rpx"}' :src="item[recommendPicture]?(baseUrl + item[recommendPicture].split(',')[0]):''"></image>
						<view :style='{"padding":"0 8rpx","lineHeight":"1.5","fontSize":"28rpx","color":"#000","textAlign":"center"}'>{{item[recommendTitle]}}</view>
						<view :style='{"padding":"0 8rpx","lineHeight":"28rpx","fontSize":"24rpx","color":"#999","textAlign":"center"}'>{{item.addtime}}</view>
					</view>
				</view>
			</view>
	...
	export default {
		...
		methods: {
			...
			async getRecommendList(){
				...
				this.recommendTable = 'jianshenkecheng'
