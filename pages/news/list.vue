	...
	<view class="content">
		<view :style='{"minHeight":"100vh","width":"100%","padding":"0","position":"relative","background":"#F4F8FB","height":"auto"}'>
			...
			<view :style='{"width":"100%","flexWrap":"wrap","display":"flex","height":"auto"}'>
				...
				<view id="news-list-7" class="news-box7 waterfall-body" :style='{"padding":"20rpx 24rpx 0","alignItems":"flex-start","flex":"1","display":"flex","width":"100%","minWidth":"calc(100% - 180rpx)","height":"auto"}'>
					<view id="waterfall-left-column-news-7" class="waterfall-column-news-7" :style='{"margin":"0 12rpx 0 0","flex":"1","flexDirection":"column","display":"flex"}'>
						<view @tap="onDetailTap(product)" :style='{"boxShadow":"0 2rpx 4rpx rgba(0,0,0,.5)","margin":"0 0 20rpx 0","overflow":"hidden","position":"relative","borderRadius":"12rpx"}' v-for="product in leftListNews7" :key="product.id" class="left-content">
							<image :style='{"width":"100%","objectFit":"cover","display":"block","height":"auto"}' mode="widthFix" :src="baseUrl+product.picture"></image>
							<view :style='{"width":"100%","position":"absolute","left":"0","background":"rgba(0,0,0,.5)","bottom":"0"}'>
					...
					<view id="waterfall-right-column-news-7" class="waterfall-column-news-7" :style='{"margin":"0 0 0 12rpx","flex":"1","flexDirection":"column","display":"flex"}'>
						<view @tap="onDetailTap(product)" :style='{"boxShadow":"0 2rpx 4rpx rgba(0,0,0,.3)","margin":"0 0 20rpx 0","overflow":"hidden","position":"relative","borderRadius":"12rpx"}' v-for="product in rightListNews7" :key="product.id" class="right-content">
							<image :style='{"width":"100%","objectFit":"cover","display":"block","height":"auto"}' mode="widthFix" :src="baseUrl+product.picture"></image>
							<view :style='{"width":"100%","position":"absolute","left":"0","background":"rgba(0,0,0,.5)","bottom":"0"}'>
								<view :style='{"padding":"0 20rpx","lineHeight":"1.5","fontSize":"28rpx","color":"#fff"}' class="title ">{{product.title}}</view>
								<view :style='{"padding":"0 20rpx","display":"none"}'>
