<template>
	<view class="content">
		<view class="box" :style='{"width":"100%","padding":"240rpx 40rpx 0","backgroundColor":"#edf2ff","backgroundSize":"100% 100%","backgroundImage":"url(http://codegen.caihongy.cn/20231206/330ac64c394b4b488d83e6264f2bd05b.gif)","height":"100%"}'>
			<view :style='{"padding":"30rpx","borderRadius":"40rpx 40rpx 0 0","background":"linear-gradient(180deg, rgba(213,224,255,0.5) 0%, rgba(255,255,255,0) 100%)","display":"block","width":"100%","position":"relative","height":"auto"}'>
				<image :style='{"margin":"0 0 0","borderRadius":"8rpx","top":"-180rpx","display":"block","width":"160rpx","position":"absolute","height":"160rpx"}' src="http://codegen.caihongy.cn/20201114/7856ba26477849ea828f481fa2773a95.jpg" mode="aspectFill"></image>
				...
				<button v-if="loginType==1" class="btn-submit" @tap="onLoginTap" type="primary" :style='{"border":"0","padding":"0px","margin":"0 0 24rpx 0","color":"rgb(255, 255, 255)","borderRadius":"40rpx","background":"#0060C8","width":"100%","lineHeight":"88rpx","fontSize":"40rpx","height":"88rpx"}'>登陆</button>
				...
				<view class="links" :style='{"width":"100%","margin":"0 0 24rpx 0","flexWrap":"wrap","display":"flex","height":"auto"}'>
					<view class="link-highlight" @tap="onRegisterTap('huiyuan')" :style='{"border":"2rpx solid #7C9EFF","padding":"10rpx 20rpx","margin":"16rpx 1%","color":"#999","borderRadius":"40rpx","textAlign":"center","width":"30%","fontSize":"28rpx"}'>注册会员</view>
				</view>
